		...
		if (!empty($_SESSION['Email'])) {
			...
			if ($checkOrder->num_rows > 0) {
				...
				while($order = mysqli_fetch_array($checkOrder)) {
					...
					$stax = 0.8 * $total;
					echo "<tr> <td colspan='4'> Sales Tax: '" . $stax . "</td></tr>";
					echo "<tr> <td colspan='4'> Order Total: '" . $total + $stax . "</td></tr>";
					
					echo "<tr rowspan='2'> <td colspan='4'> Shipping Address: " . $address . "</td></tr>";
					echo "<tr>";
					echo " <td colspan='2'><input type='submit' value='Confirm Order'></td>" ;
					echo " <td colspan='2'><button onclick ='browse.php' >Continue Shopping</td>";
					echo "</tr>";
					echo '</table>';
				}
			} 
