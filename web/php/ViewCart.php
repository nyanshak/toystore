		...
		while ($order = mysqli_fetch_array($checkOrder)) {
			...
			if ($orderItems->num_rows > 0) {
				...
				while ($itemDetail = mysqli_fetch_array($orderItems)) {
					...
					echo "<td><input type='text' id='itemQuantity" . $i . "' size='2' maxLength='3' value=" . $quantity . ">&nbsp;<a href='' id='updateQuant" . $i . "'> Update </a> <input type='hidden' id='productId' value=" . $productId . "> <input type='hidden' value=" . $i . "></td>";
